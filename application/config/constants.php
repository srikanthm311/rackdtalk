...
defined('TIMEBEFORE_DAY')         OR define( 'TIMEBEFORE_DAY',         '{num} day ago' );
defined('TIMEBEFORE_DAYS')        OR define( 'TIMEBEFORE_DAYS',        '{num} days ago' );
defined('TIMEBEFORE_WEEK')        OR define( 'TIMEBEFORE_WEEK',        '{num} week ago' );
defined('TIMEBEFORE_WEEKS')       OR define( 'TIMEBEFORE_WEEKS',       '{num} weeks ago' );
defined('TIMEBEFORE_MONTH')       OR define( 'TIMEBEFORE_MONTH',       '{num} month ago' );
defined('TIMEBEFORE_MONTHS')      OR define( 'TIMEBEFORE_MONTHS',      '{num} months ago' );
defined('TIMEBEFORE_FORMAT')      OR define( 'TIMEBEFORE_FORMAT',      '%e %b' );
