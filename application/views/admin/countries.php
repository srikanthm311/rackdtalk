...
<div class="memberlogin-wps col-md-12 products_page">
  ...
  <div class="search">
  <div style="margin-left: 14px;"> search</div>
  <form action="" method="post">
  <div style="width:100%; float:left;">
      <input type="text" class="form-control" name="country_title" style="width:50%; float:left; box-shadow: none; margin-bottom: 12px; margin-left: 12px;"placeholder="enter country name"/>
      <span><input class="btn btn-primary btn-style-rev" style=" margin-left:20px; margin-top: 0 !important;" type="submit" value="search" /></span>
      <input type="hidden" name="identity" value="1"></div>
  </form>
  </div>
	...
	<!-- Table Body -->
	 ...
	 <tbody>    <?php $i=1;
                 ...
                 ?>
                    ...
                    <td style=" text-align:center"><a href="<?php echo base_url('admin/edit_country/'.$country['id'])?>"><i class="fa fa-pencil" aria-hidden="true"></i></a></td>
