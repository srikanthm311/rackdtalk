...
<?php if(isset($rights['admincategory'])){?>    
  ...
  <?php  }?>
  <?php if(isset($rights['adminrevenue'])){?> 
  <a href="<?php echo base_url('adminrevenue')?>" class="list-group-item1 list-group-item-success1 <?php echo (($this->router->fetch_class()=='adminrevenue'))? 'active':''?>"><i class="fa fa-cog" aria-hidden="true"></i>Revenue</a>
<?php  }?>
<?php if(isset($rights['adminsubscriptions'])){?> 
...
<?php if(isset($rights['adminquestions'])){?>
...
<?php }?>
 ...
 <?php if(isset($rights['adminusers'])){?>
...
<?php }?>
  ...
  <?php if(isset($rights['admin/settings'])){?>
...
<?php if(isset($rights['adminTestimonials'])){?>
...
<a href="<?php echo base_url('admin/frequent_takers')?>" class="list-group-item1 list-group-item-success1 <?php echo (($this->router->fetch_method()=='frequent_takers'))? 'active':''?>"><i class="fa fa-cog" aria-hidden="true"></i>Frequent Takers</a>
       
       <a href="<?php echo base_url('admin/trending_talkers')?>" class="list-group-item1 list-group-item-success1 <?php echo (($this->router->fetch_method()=='trending_talkers'))? 'active':''?>"><i class="fa fa-cog" aria-hidden="true"></i>Trending Talkers</a>
