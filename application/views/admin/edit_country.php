    ...
    <form method="post" role="form" action="<?php echo base_url('admin/edit_country/')?>">
      ...
      <div class="form-group">
        ...
        <div class="col-md-10">
          ...
          <input type="text" class="form-control form-shadow" id="ccode" name="ccode" value="<?php echo $country_details['sortname']; ?>" placeholder="Enter Country code" required>
      ...
      <div class="form-group">
        ...
        <div class="col-md-10">
          ...
          <input type="text" class="form-control form-shadow" id="cname" name="cname" value="<?php echo $country_details['name']; ?>" placeholder="Enter Country Name" required>
      ...
      <div class="form-group">
        ...
        <div class="col-md-10">
          ...
          <input type="text" class="form-control form-shadow" id="cpcode" name="cpcode" value="<?php echo $country_details['phonecode']; ?>" placeholder="Enter Country phone Code" required>
