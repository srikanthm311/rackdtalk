...
<div class="memberlogin-wps col-md-10 products_page category-width">
    ...
    <div class="dashboard-main-block">
        ...
        <div class="dashboard-main-btn">
            <a class="category_add" href="<?php echo base_url('admincategory/add_category')?>">Add New Category</a>
        </div>
    </div>
	 ...
	 <tbody>    <?php $i=1;
                 ...
                 ?>
                  ...
                  <?php /*?>  <td><?php echo $sub['slug']?></td><?php */?>
                    ...
                    <td class="textbutton"> <a href='<?php echo base_url('admincategory/add_category/'.$sub['id'])?>' data-toggle="tooltip" data-placement="top" title="Edit" class="fa fa-edit"></a></td>

                    <td > <a onclick='return confirm("Are you sure?")' href='<?php echo base_url('admincategory/deletecategory/'.$sub['id'])?>' class="fa fa-trash"></a></td>
...

{
	...
	$.ajax({
		...
		url: '<?php echo base_url('admincategory/updateMenuStatus'); ?>',
