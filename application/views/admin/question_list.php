...
<div class="memberlogin-wps col-md-12 products_page">
  ...
  <form method="post" action=""/>
        <div class="row">
            ...
            <div class="col-md-3">
           <div class="form-group form-group-50">
                <input class="btn-style-rev" type="submit"   id="submit"  name="submit" value="submit" class="btn btn-success btnl-class">
        ...
        <div class="dashboard-main-block">
            ...
            <div class="dashboard-main-btn">
                <a class="category_add" href="<?php echo base_url('adminquestions/post_your_question')?>">Post Question</a>
            </div>
        </div>
...
function viewMore(qid)
{
	...
	$.ajax({
		...
		url: '<?php echo base_url('adminquestions/questionDetails'); ?>',
