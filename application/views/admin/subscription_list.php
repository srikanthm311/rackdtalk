...
<div class="memberlogin-wps col-md-12 products_page">
    ...
    <div class="dashboard-main-block">
        ...
        <div class="dashboard-main-btn">
            <a class="category_add" href="<?php echo base_url('adminsubscription/add_subscription')?>">Add Subscription</a>
        </div>
    </div>
	...
	<!-- Table Body -->
	 ...
	 <tbody>    <?php $i=1;
                 ...
                 ?>
                    ...
                    <td><a href='<?php echo base_url('adminsubscription/add_subscription/'.$subscription['id'])?>' class="fa fa-edit"></a></td>

                    <td > <a onclick='return confirm("Are you sure?")' href='<?php echo base_url('adminsubscription/deleteSubscription/'.$subscription['id'])?>' class="fa fa-trash"></a></td>
...

{
	...
	$.ajax({
		...
		url: '<?php echo base_url('adminsubscription/updateSubscriptionStatus'); ?>',
