...
<div class="memberlogin-wps col-md-10 products_page">
    ...
    <div class="dashboard-main-heading"><h2><?php echo ($user['id'] != '') ? 'Update' : 'Add'; ?> Customer</h2></div>
...
<span class='server-error'></span>
    <form method="post" role="form" id="add-location-form" class="validate-form" action="<?php echo base_url('superadminusers/add_user')?>">
      ...
      <div class="form-group">
       ...
       <div class="form-group">
        ...
        <div class="col-md-6">
          ...
          <input style="margin-left: 40px;" type="checkbox" class="" id="is_delted" name="is_delted" value="1" <?php echo (($user['is_delete']==1))?'checked':'';?>/>Is Deleted
      ...
      <div class="form-group">
        ...
        <label class="col-md-2 catogery_name">Revenue</label>

        <div class="col-md-6">

          <input type="checkbox" class="form-contro" id="revenue_right" name="questionsRight[]" value="adminrevenue"/>
      ...
      <div class="form-group">
        ...
        <div class="col-md-6">
          ...
          <button type="submit" class="btn btn-primary location_button btn-style-rev"><?php echo ($user['id'] != '') ? 'Update' : 'Add'; ?></button>
