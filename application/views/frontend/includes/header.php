     ...
     fjs.parentNode.insertBefore(js, fjs);
      ...
      <div class="container">
        <div class="navbar-header">
          ...
          <span href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-bell" aria-hidden="true"></i><span class="how_many"><!--(2)--></span></span>
          <ul class="dropdown-menu notify-drop">
            <div class="notify-drop-title">
            	<div class="row">
            		<div class="col-md-6 col-sm-6 col-xs-6"><h5>Notifications </h5><!--(<b>2</b>)--></div>
            ...
            <div class="drop-content">  <?php foreach($notifications as $notification){?> 
            	<li>
...
<form method="post" name="forgotform" id="forgotform" onSubmit="return forgotpwd()" class="fwd_form" action="<?php echo base_url()?>main/forgot_pwd">
  ...
  <div class="modal-dialog success_message_pop" role="document">
      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
       <div class="modal-content">
        ...
        <div class="addmoney"> 
            <h2><?php echo $this->lang->line('forgot_your_password'); ?></h2> <span id='fwd-error'></span>
            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry Lorem Ipsum is simply dummy text of the printing and typesetting industry</p>
            <div class="moneyinput"><span  class="Errtg" id="Errfusername"></span>
                <input type="text" class="form-control" placeholder="<?php echo $this->lang->line('email'); ?>" name="forgot_pwd" id="fusername" autocomplete="off"> 
