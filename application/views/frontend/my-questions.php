                               ...
                               <div class="trending-left-inner">
                                <div class="col-md-2">
                                    <div class="trending-right-inner">
                                        ...
                                        <div class="bar">
                                            <ul> <?php if($question['question_comment_count']>20) { ?>  <li><div class="green-bar"></div></li>  <?php }  ?>
...
$(function(){
	...
	$('#close-button-verify').click(function(){ var id=$(this).attr('id');
    $('.simple-ajax-popup-'+id).magnificPopup('close');
    });	
